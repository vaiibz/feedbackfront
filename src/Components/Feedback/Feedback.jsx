      ...
      <Box sx={{ px: { xs: "0.9rem", md: "5rem" } }}>
        ...
        <Grid container>
          ...
          <Grid
            ...
            xs={12}
            md={9.5}
            sx={{ p: { xs: 0, sm: 2 }, mt: { xs: 2, md: 0 } }}
          >
            <Box
              sx={{
                width: "100%",
                border: "2px solid #36416A",
                p: { xs: 0.2, md: 1.2 },
                borderRadius: "10px",
                px: 4,
                display: "flex",
              ...
              {products
                ...
                .map((item) => (
                  <Box
                    ...
                    sx={{
                      backgroundColor: "rgba(54, 65, 106, 0.15)",
                      my: 2,
                      display: "flex",
                      flexDirection: "column",
                      p: 2,
                  ...
                  >
                    ...
                    {openCommitBox[item._id] ? (
                      <Box sx={{ px: { xs: 0, md: 2 }, mt: 2 }}>
                        ...
                        <Box
                          sx={{ height: "150px", overflowY: "scroll", p: 1 }}
                        >
                          <ol>
